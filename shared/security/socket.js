...
var { Ci, Cc, CC, Cr, Cu } = require("ff-devtools-libs/sham/chrome");
...
const { DebuggerTransport } = require("ff-devtools-libs/shared/transport/transport");
const { DebuggerServer } = require("ff-devtools-libs/server/main");
const discovery = require("ff-devtools-libs/shared/discovery/discovery");
const cert = require("ff-devtools-libs/shared/security/cert");
const { Authenticators } = require("ff-devtools-libs/shared/security/auth");
