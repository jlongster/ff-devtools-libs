...
ToolSidebar.prototype = {
  ...
  handleEvent: function(event) {
    ...
    if (previousTool) {
      let prevTab = this._tabs.get(previousTool);
    ...
    let currTab = this._tabs.get(this._currentTool);
    currTab.setAttribute("selected", "true");
    currTab.setAttribute("visuallyselected", "true");
